...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, abrindo um [Security Advisory privado](https://github.com/sirelves/boracall/security/advisories/new) ou pelo e-mail no perfil do repositório. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
