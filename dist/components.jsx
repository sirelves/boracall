...
const STRINGS = {
  pt: {
    ...
    tweaks: "Tweaks",
    // landing
    tagline_1: "Chamada de voz", tagline_2: "sem enrolação.",
    lede: "Bora falar? Cria uma sala, compartilha o link e pronto. Áudio limpo, interface que não atrapalha.",
    kv_latency: "Latência", kv_latency_v: "< 50ms p50",
    kv_codec: "Codec", kv_codec_v: "Opus 48kHz",
    kv_cost: "Custo", kv_cost_v: "de graça até 20",
    cta_start: "Criar conta grátis", cta_have: "Já tenho conta",
    demo_label: "Sala demo · agora",
    // auth
